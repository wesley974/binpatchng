#===========================================================================
# Prepare x509 Certificate
#
# mkdir /pkgcrt
# openssl genrsa -out /pkgcrt/server.key 2048
# openssl req -new -key /pkgcrt/server.key -out /pkgcrt/server.csr
...
# List of patches for userland, avoid X11 (029_xorg_libs)
